...
public sealed class ATMBoundUserInterface : BoundUserInterface
{
    ...
    private TransactionMenu? _transactionWindow;
    private BankAccountComponent? _account;
    ...
    protected override void Open()
    {
        ...
        _menu.OnNumberEntered += s =>
        {
            ...
            _menu.CreateInfoBoxForAccount(account.Value);
            _account = account;
        };

        _menu.OnClearButtonPressed += ClearMenu;

        _transactionWindow = new TransactionMenu();
